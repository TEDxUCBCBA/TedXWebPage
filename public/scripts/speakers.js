    ...
    switch(target.id) {
        case 'adri-zurita':
            createModal('Adriana Zurita', 'Es licenciada en Derecho, egresada en Ciencias Políticas, y con una maestría en Comunicación Corporativa. Actualmente forma parte del equipo de la campaña “Actúa Detén la Violencia” en la ciudad de La Paz, que se encarga de apoyar y dar a conocer sobre los derechos de la mujer y evitar la violencia. ',
                'Tema de su charla:  Amor y violencia en tiempos de Redes Sociales.',
                'Una reflexión sobre el papel de los ciberespacios, sobre como pueden convertirse un un lugar para generar relaciones sanas o un lugar más para reproducir violencia. ¿Mayor motivación?  El amor y la esperanza ambos como una fuente de revolución. ¿Mayor admiración?  Cualquier persona revolucionaria.');
            break;
        ...
        case 'amples-regani':
            createModal('Amples Regiani', 'Brasileño con más de once años de experiencia publicitaria en diferentes países de Latinoamerica. Ha sido co-creador de la campaña “Soy Capaz”, el mayor movimiento en favor de la paz en la historia de Colombia, involucrando centenas de marcas, artistas, deportistas y millones de personas. Durante su carrera fue reconocido con premios internacionales en Argentina, Estados Unidos, Alemania, Francia, Inglaterra y Colombia por su trabajo para marcas como Coca-Cola, Nestlé, Kimberly Clark, Tramontina, Lexus y otras.  ',
                'Tema de su charla: ¿Estamos reprimiendo nuestras emociones?',
        ...
        case 'andres-palacios':
            createModal('Andrés Palacios', 'Artista plástico boliviano y manager de diseño y desarrollo de productos del Museo Metropolitano de Arte de Nueva York (El MET), uno de los museos de arte más grandes y concurridos del mundo. El trabajo de Andrés se caracteriza por el diseño de productos vinculados a la identidad y patrimonio cultural. ',
                'Tema de su charla:  El camino de un polímata.',
                'Esta se basara en mostrar una perspectiva poco conocida sobre el aprendizaje y potencial del ser humano para superarse y realizar sus metas y sueños.¿Motivación personal? Crear en base a la creatividad ¿Dato curioso?  En su tiempo libre, Andrés realiza acrobacia aérea en tela, trapecio y aro.')
            break;
        ...
        case 'davor-pavisic':
            createModal('Davor Pavisic', 'Director de Tecnología en Jalasoft SRL, con una historia basada en el trabajo de la industria del software informático. Es sin duda un profesional con gran conocimiento sobre tecnología de la información con experiencia en bioinformática, lenguajes de bajo nivel, metodologías ágiles, diseño de software y activista de innovación. ',
                'Tema de su charla:  ¿Qué hace a una sociedad innovadora y creativa?',
                'Una charla que tendrá el enfoque de despertar una gran motivación en la audiencia para así inspirar el espíritu innovador y el cambio. ¿Mayor motivación?  La curiosidad de saber. ¿A quien admira?  Robert M. Manning ¿Dato curioso?  Desde varios años el y un grupo de amigos se dedican a fabricar y lanzar cohetes de alto poder (High Powered Rocketry).')
            break;
        ...
        case 'erna-jugstain':
            createModal('Erna Jungstein', 'Humanista, idealista, activista y politóloga de profesión. Durante un viaje de dos años por Medio Oriente y Asia del Sur, Erna descubrió la importancia de romper esquemas, expandir sus horizontes y cuestionarse a cerca de los motivos más profundos del alma humana y las relaciones interpersonales. Ella actualmente trabaja en la función pública sin dejar de lado la investigación y gestión de proyectos relacionados al empoderamiento de poblaciones vulnerables y la igualdad de oportunidades.',
                'Tema de su charla:  Es valiente e inteligente, ser amable.',
                'Una charla donde se resaltara la bondad como la mayor virtud, fortaleza y estrategia que puede desarrollar el ser humano. ¿Libro favorito?  La lucha es mi vida (Nelson Mandela) ¿Mayor admiración?  A quienes ante la dificultad, lo injusto y doloroso, deciden el amor.')
            break;

        case 'esteban-quispe':
            createModal('Esteban Quispe', 'Este joven boliviano revolucionó la creación de robots con materiales reciclados. Esteban se dedica a la investigación de la robótica con el objetivo de fabricar robots para la agricultura, innovando ideas amigables para el medio ambiente y diferentes comunidades.',
                'Tema de su charla:  Robots de Reciclaje cuidando la Madre Tierra.',
                'Una charla que se basara en re descubrir la utilidad de la basura para la tecnología y más aun en conocer una historia que dio vuelta al sistema.¿Mayor motivación? Las necesidades ante la economía para la construcción de sus robots.¿Mayor admiración? Sus padres.')
            break;

        case 'esther-coronel':
            createModal('Esther-coronel', 'Con 35 años de experiencia en las áreas de Business, Educación y Desarrollo Personal, ella es conferencista y mentora de líderes a nivel internacional. Es entrenadora en PNL Programación Neurolingüística certificada por Richard Bandler y muchos más. Considera que los ingredientes imprescindibles que llevan al éxito son: claridad, confianza y autoestima.',
                'Tema de su charla:  Innovación y Creatividad: Una urgente necesidad',
                'Esta misma estará enfocada en como cambiar la manera de percibir y pensar en relación al trabajo ¿Mayor motivación? Su propia esencia¿Mayor característica? Para ella son muchas, como ser visionaria, persistente, creativa e innovadora')
            break;
        ...
        case 'lesly-zerna':
            createModal('Lesly Zerna', 'Ella es Ingeniera en Telecomunicaciones y tiene una Maestría en Ciencias de la Computación en Bélgica. Actualmente, es co-embajadora de la comunidad "City.AI" en Cochabamba, que se encarga de promover experiencias sobre la Inteligencia Artificial aplicada. Asimismo, ella es activista en temas de empoderamiento de mujeres en la tecnología.',
                'Tema de su charla: Aprender y poder',
                'Una charla que se enfocara en el valor del auto aprendizaje y el porqué es importante aprender cosas nuevas por uno mismo. ¿Mayor motivación?  La curiosidad y la pasión por vivir nuevas aventuras. ¿A quien admira?  Emprendedoras y tecnólogas: Cassidy Williams y Bel Pesce ¿Dato curioso?  A Lesly le gusta mucho la música, la tecnología, los viajes, la poesía y el teatro.')
            break;
        ...
        case 'steve-camargo':
            createModal('Steve Camargo', 'El es fotógrafo y su principal enfoque es el documental y el fotoreportaje. Actualmente trabaja para las agencias Photoshot (UK) y Avalon (UK) y es documentalista freelance como también docente universitario. Entre sus reconocimientos destacan premios documental como Humanity Photo Awards, Selección Oficial Photofest y Adocs.',
                'Tema de su charla:  Una imagen vale más que mil palabras. ¿Se puede aplicar esta afirmación a todas las fotografías?',
                ' ¿Libro favorito?  Antología de la literatura fantástica ¿Mayor admiración?  Werner Herzog, en días impares.')
            break;
        ...
        case 'tessa-henwood':
            createModal('Tessa Henwood-Mitchell', 'Emprendedora social australiana y experta en el campo del desarrollo internacional y empoderamiento de jóvenes. Es la Fundadora y Directora Internacional de TIA, una organización en Bolivia, sin ánimo de lucro, que trabaja junto con jóvenes durante la etapa de transición del cuidado estatal a la independencia, con la idea de poder empoderarlos para que se conviertan en miembros prósperos de la sociedad ',
                'Tema de su charla:  Ser la persona que cree en alguien, puede hacer toda la diferencia.',
...
function createModal(speakerName, speakerDescription, talkName, talkDescription) {
    ...
    function addContent(speakerName, speakerDescription, talkName, talkDescription) {
        Headertitle.textContent = speakerName;
        text1.textContent = speakerDescription;
        Subtitle.textContent = talkName;
        text2.textContent = talkDescription;
    ...
    addClasses();
    addLogic();
    addContent(speakerName, speakerDescription, talkName, talkDescription);
    appendToBody();
